...
HParray = np.array([[20, 50, 10],[20,50,5]])
...
#plt.plot([],[],label='horizons = {}, states = {}, actions = {}'.format(horizons,No_of_states,No_of_actions))
    ...
    plt.title('Optimal J_0: N = {}, #S = {}, #A = {}'.format(horizons, No_of_states, No_of_actions))
    plt.xlabel('States')
...
#plt.show()
    ...
    plt.title('Optimal Policy: N = {}, #S = {}, #A = {}'.format(horizons, No_of_states, No_of_actions))
    plt.xlabel('States')
