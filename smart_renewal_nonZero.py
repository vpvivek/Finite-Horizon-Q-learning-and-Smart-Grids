...
maximum_demand = 4
demand_array = [1, 2, 3, 4] # 3 possible demands valued 1,2,3

maximum_renewal = 4
renewal_array = [1, 2, 3, 4] # 3 possible renewal energy valued 1,2,3

maximum_price = 4
price_array = [1, 2, 3, 4] # 3 possible prices valued 1,2,3
